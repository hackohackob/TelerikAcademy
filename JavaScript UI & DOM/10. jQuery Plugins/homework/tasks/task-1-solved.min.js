function solve() {
    var t = "select",
        e = "The element must be a SELECT", a = "<div />", n = "option", d = "dropdown-list", o = "current", r = "options-container", l = "position", i = "absolute", s = "data-value", c = "data-index", h = "dropdown-item", p = "click", v = ".current", u = "display", m = "none", f = "Select a value", w = ".dropdown-item";
    return function (C) {
        var b = $(C);
